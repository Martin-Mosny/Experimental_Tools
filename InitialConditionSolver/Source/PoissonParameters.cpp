...
void getPoissonParameters(PoissonParameters &a_params)
{
    ...
    pp.get("Gaussian_initial_conditions", a_params.Gaussian_initial_conditions);
    pp.get("Gaussian_init", a_params.Gaussian_init);
    pp.get("Gaussian_amplitude", a_params.Gaussian_amplitude);
